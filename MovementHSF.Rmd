---
title: "Movement-based Habitat Selection Guidance <br> (in practice)"
...
```{r covs.plot, class.source = "fold-hide"}
...
```{r first.fit.inference.poisson.tmb}
...
one = data.frame(N.Avail=rep(n.avail2,each=20),
                 Sample=rep(1:20,length(n.avail2)),
                 beta = coef.save[,1]
                )
two = data.frame(N.Avail=rep(n.avail2,each=20),
                 Sample=rep(1:20,length(n.avail2)),
                 beta = coef.save[,2]
                )
three = data.frame(N.Avail=rep(n.avail2,each=20),
                 Sample=rep(1:20,length(n.avail2)),
                 beta = coef.save[,3]
                )
